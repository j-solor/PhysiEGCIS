...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"/>
  ...
  <Model key="Model_1" name="New Model_2" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221408570000002e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4948" name="Warburg_param" value="0"/>
          <Constant key="Parameter_4947" name="k_aer_w" value="0.001"/>
          <Constant key="Parameter_4946" name="k_aer" value="0.01"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4942" name="k1" value="0.0023"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model_2,Vector=Values[k_ane]" value="0.001" type="ModelValue" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model_2,Vector=Reactions[Anaerobic]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model_2,Vector=Reactions[Anaerobic],ParameterGroup=Parameters,Parameter=k_ane_w" value="0.10000000000000001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
            ...
            <ModelParameter cn="CN=Root,Model=New Model_2,Vector=Reactions[Anaerobic],ParameterGroup=Parameters,Parameter=k_ane" value="0.001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
