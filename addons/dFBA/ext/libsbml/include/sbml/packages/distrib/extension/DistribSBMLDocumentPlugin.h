 ...
 * @brief Definition of the DistribSBMLDocumentPlugin class.
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
 ...
 * ------------------------------------------------------------------------ -->
 *
 * @class DistribSBMLDocumentPlugin
 * @sbmlbrief{distrib} Extension of SBMLDocument.
 */
...
public:
   ...
   */
  DistribSBMLDocumentPlugin(const std::string& uri,
   ...
   *
   * @param rhs the DistribSBMLDocumentPlugin object whose values are to be
   ...
   *
   * @return @c true if this DistribSBMLDocumentPlugin's attribute
